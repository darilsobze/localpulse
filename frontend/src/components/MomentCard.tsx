...
import chocoLatteImage from '../assets/choco_latte_high_protein.png';
  ...
  return (
    ...
    >
      ...
      <div className="relative h-[142px] mt-8 px-4">
        ...
        <motion.img
          src={chocoLatteImage}
          alt="High-protein choco latte"
          initial={{ rotate: -4, y: 8, scale: 0.95 }}
          animate={{ rotate: [-4, -2, -4], y: [8, 0, 8], scale: [0.95, 1, 0.95] }}
          transition={{ duration: 7, repeat: Infinity, ease: 'easeInOut' }}
          className="absolute inset-x-0 top-[-12px] mx-auto h-[166px] w-auto object-contain drop-shadow-2xl"
        />
      </div>
