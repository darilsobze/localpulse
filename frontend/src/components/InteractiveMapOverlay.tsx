...
import { DEFAULT_COORDS } from '../lib/offer';

type Props = {
  onClose: () => void;
};

// Source-of-truth comes from `offer.DEFAULT_COORDS` so the demo override
// (gym in Darmstadt) flows through to the map overlay too.
const USER_LOCATION: [number, number] = [DEFAULT_COORDS.lng, DEFAULT_COORDS.lat];
const BACK_FACTORY: [number, number] = [8.650439, 49.872310];
