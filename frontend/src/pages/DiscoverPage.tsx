...
export default function DiscoverPage() {
  const offers = [
    { name: 'BACK FACTORY', distance: '100m', discount: '-20%', item: 'High-Protein Choco-Latte', icon: '🥤' },
      ...
      >
        <div className="flex items-center justify-center h-full">
          <div className="text-center text-stone-700/70">
            ...
            <div className="text-[13px] mt-2">Tram stop → BACK FACTORY</div>
            <div className="text-[11px] text-stone-700/60 mt-1">
              12° · Sunny · post-training
            </div>
          </div>
        </div>
      </div>
